    ...
    <div class="max-w-md w-full px-8 py-10 bg-document border-4 border-ink">
        ...
        <form action="/upload" method="POST" enctype="multipart/form-data" id="uploadForm" class="space-y-8">
            <div class="space-y-3">
                ...
                <div id="dropZone" class="relative border-2 border-dashed border-ink hover:bg-slate-100 transition-colors p-4 flex justify-center">
                    ...
                    <div class="text-center">
                        ...
                        <p id="fileNameText" class="text-sm font-medium text-slateUI">Pilih file atau seret ke sini</p>
    ...
    <script>
        ...
        fileInput.addEventListener('change', function(e) {
            if (e.target.files.length > 0) {
                ...
                fileNameText.innerText = `📄 ${fileName} dipilih`;
                fileNameText.classList.remove('text-slateUI');
                fileNameText.classList.add('text-ink-green', 'font-bold');
                dropZone.classList.remove('border-dashed', 'border-ink');
                dropZone.classList.add('border-solid', 'border-ink-green');
            } else {
                fileNameText.innerText = 'Pilih file atau seret ke sini';
                fileNameText.classList.remove('text-ink-green', 'font-bold');
                fileNameText.classList.add('text-slateUI');
                dropZone.classList.remove('border-solid', 'border-ink-green');
                dropZone.classList.add('border-dashed', 'border-ink');
            }
        });
